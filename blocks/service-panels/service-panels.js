const ARROW_SVG = `<svg class="service-areas-arrow" xmlns="http://www.w3.org/2000/svg" width="89" height="88" viewBox="0 0 89 88" fill="none" aria-hidden="true" focusable="false">
...
export default function decorate(block) {
  ...
  block.classList.add(`service-areas-${panels.length}-cols`);

  panels.forEach((panel) => {
    panel.classList.add('service-areas-panel');
